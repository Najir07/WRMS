              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Number of Applied Jobs</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $candidate["applied"]; ?></div>
                    </div>
                    <div class="col-auto">
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $candidate["active_job"]; ?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-highlighter fa-2x text-gray-300"></i>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Profile Progress</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                            <?php
                             $progress = calculate_profile_progress($candidate["id"]); 
                             echo $progress; 
                             ?>%
                          </div>
                        </div>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $candidate["pending_job"]; ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-12">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-info">Your CV</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6 text-center">
                      <img src="<?php echo $candidate["pro_img_location"]; ?>" class="img-responsive rounded-circle mb-4 w-50">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-xl-6">
                      <h5 class="font-weight-bold text-primary mb-4">Educational Background:</h5>
                      <?php get_cv_edu_info($candidate["user_directory"]); ?>
                    </div>
                    <div class="col-xl-6">
                  ...
                  <div class="row">
                    <div class="col-xl-12">
                      ...
                      <div class="m-4">
                        <?php get_cv_skills($candidate["user_directory"]); ?>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-xl-12">
                      <a href="profile.php" class="btn btn-block btn-primary">Edit your CV</a>
                    </div>
                  </div>      
